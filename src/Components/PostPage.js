      ...
      <View style={{flex: 1}}>
        ...
        <View
          ...
          style={{
            height:
              Platform.OS === 'ios'
                ? variables.workingScreenHeigth - 60 - 70 - 20
                : variables.deviceHeight - 50 - variables.deviceStatusBar - 70,
            borderWidth: 4,
            borderColor: 'yellow',
          }}>
          <FlatList
              ...
              return (
                <View style={stylesItem.item}>
                  ...
                  <View style={stylesItem.reactionContainer}>
                    ...
                    <TouchableOpacity
                      onPress={() => props.makeReaction2('LIKE')}>
                      <FontAwesome5Icon
                        name="thumbs-up"
                        color="#318bfb"
                        backgroundColor="#fff"
                    ...
                    <TouchableOpacity
                      onPress={() => props.makeReaction2('SAD')}>
                      <FontAwesome5Icon
                        name="frown-open"
                        color="#e8304a"
                        backgroundColor="white"
